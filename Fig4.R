...
# This script shows how to reproduce the results in Figure 4 of Gupta et. al (version June 2020)
...
par(mar = c(5,5,2,5))
plot(count_table$Healthy, type="o", col="steelblue", pch="o", lty=1,xaxt='n',yaxt='n',xlab = "GMHI Bins",ylab = "Proportion of Samples (%)",ylim=c(0,100))
par(new=T)
plot(count_table$Nonhealthy, type="o", col="orange2", pch="o", lty=1,xaxt='n',yaxt='n',xlab = '',ylab = '',ylim=c(0,100),main = "Fig4a")
...
GMHI_alpha_plot_H_U$Phenotype<-gsub(x = GMHI_alpha_plot_H_U$Phenotype, pattern = "[^Healthy].+|advanced adenoma", replacement = "Nonhealthy")
fig4b<-ggscatterhist(
